...
urlpatterns = [
    ...
    path('get-inspecciones-botella/sat_hash/<str:sat_hash>', views.lista_inspecciones_botella, name='get-inspecciones-botella'),
    path('get-detalle-botella-inspeccion/inspeccion/<int:inspeccion_id>/sat_hash/<str:sat_hash>', views.detalle_botella_inspeccion, name='get-detalle-botella-inspeccion'),
    path('get-detalle-botella-inspeccion-post/', views.detalle_botella_inspeccion_post, name='get-detalle-botella-inspeccion-post'),
    ...
    path('consultar-botella/', views.consultar_botella, name='consultar-botella'),
    #path('consultar-botella/sat_hash/<str:sat_hash>', views.consultar_botella, name='consultar-botella'),
